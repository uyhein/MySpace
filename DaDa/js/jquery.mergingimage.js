(function($,sr){
 ...
 $(function() {
				...
				function removeNavigation(){
					$im_next.stop().animate({'right':'-50px'},500);
					$im_prev.stop().animate({'left':'-50px'},500);
				}
				
				//add the navigation buttons
				function addNavigation(){
					$im_next.stop().animate({'right':'0px'},500);
					$im_prev.stop().animate({'left':'0px'},500);
				}
